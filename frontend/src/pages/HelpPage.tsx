  ...
  return (
    <div>
      ...
      <section className="mt-6 border border-ba-line bg-white p-6">
        <h2 className="font-display text-2xl font-bold">Meet Chuk</h2>
        <p className="mt-3 max-w-3xl text-base text-ba-ink/80">
          Chuk is the AI advisor in this product. It is software, not a
          ...
          When you act on the advice, Chuk measures what it saved or earned
          you and keeps the receipts in your impact ledger.
        </p>
        <p className="mt-3 max-w-3xl text-base text-ba-ink/80">
          Chuk follows one rule above all: never guess. Every figure is
          calculated from your records, every calculation is shown step by
          step, and when data is missing, Chuk asks for it instead of
          estimating.
        </p>
      ...
      <p className="mt-8 text-sm text-ba-ink/60">
        Chuk provides information to support your decisions; it is not
