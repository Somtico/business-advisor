...
export const advisorScreenshots = [
  {
    sources: {
      desktop: '/images/screenshots/command-centre-v4.png',
      tablet: '/images/screenshots/command-centre-v4-tablet.png',
      phone: '/images/screenshots/command-centre-v4-phone.png',
    },
  ...
  {
    sources: {
      desktop: '/images/screenshots/pricing-advisor-v4.png',
      tablet: '/images/screenshots/pricing-advisor-v4-tablet.png',
      phone: '/images/screenshots/pricing-advisor-v4-phone.png',
    },
  ...
  {
    sources: {
      desktop: '/images/screenshots/action-centre-v4.png',
      tablet: '/images/screenshots/action-centre-v4-tablet.png',
      phone: '/images/screenshots/action-centre-v4-phone.png',
    },
  ...
  {
    sources: {
      desktop: '/images/screenshots/ask-advisor-v4.png',
      tablet: '/images/screenshots/ask-advisor-v4-tablet.png',
      phone: '/images/screenshots/ask-advisor-v4-phone.png',
    },
  ...
  {
    sources: {
      desktop: '/images/screenshots/help-faq-v4.png',
      tablet: '/images/screenshots/help-faq-v4-tablet.png',
      phone: '/images/screenshots/help-faq-v4-phone.png',
    },
