...
- Auto Chuk (AI advisor) with usage metering (Claude preferred → OpenAI fallback; Gemini removed; privacy-aware request flags). Local fallback restates leak/impact/pricing verdicts without dumping tool JSON into the chat.
