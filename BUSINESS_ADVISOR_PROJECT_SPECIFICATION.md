...
- Chuk branding (14 Aug 2026): the AI is named **Chuk** in all user-facing copy — nav ("Ask Chuk"), chat page, Pricing Advisor, Action Centre messages, Command Centre "Chuk's Impact" card, weekly brief, and the system prompt (the model refers to itself as Chuk). The gloss ("Chuk, the AI advisor" / software, not a person) appears only on the first mention: AppShell for signed-in pages, the landing hero and Privacy section 3 for public pages, and the FAQ "Who is Chuk?". Later mentions on the same page are just **Chuk**. The product name is **AI Business Advisor**.
